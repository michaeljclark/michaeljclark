...
- [glcube](https://github.com/michaeljclark/glcube) - glcube is an OpenGL cube demo in C11 using programmable shaders.
- [glhash](https://github.com/michaeljclark/glhash) = glhash is an OpenGL compute shader implementing SHA-2-256 in GLSL.
...
- [glkitty](https://github.com/michaeljclark/glkitty) - port of the iconic OpenGL gears demo to the kitty terminal graphics protocol.
...
- [libmemory](https://github.com/michaeljclark/libmemory/tree/alignment-block-splitting) - simple implementation of malloc() and free() with unified alignment handling.
...
- [vkgears](https://github.com/michaeljclark/vkgears) - port of the iconic OpenGL gears demo to GLSL and the Vulkan API using GLFW.
